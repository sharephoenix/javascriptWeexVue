<template>
  <div class="body">
    <div class="web-cls">
      <web ref="rootWeb" class="web-cls" src="https://sharephoenix.github.io/blog/main/#/index.js" @storage="storageEvent" @XHBAudioPlayerModule="XHBAudioPlayerModule" @XHBNetworkModule="XHBNetworkModule"></web>
